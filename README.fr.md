<div align="center">
  <img src="assets/hero.svg" alt="NIAK — produit, systèmes et automatisation" width="100%" />
...
Je préfère les outils inspectables et reproductibles, avec une séparation claire entre ce qu'un système sait, suppose et prouve réellement.
...
`architecture provider` · `automation` · `native labs` · `validation` · `JavaScript`
...
## Principes auxquels je reviens souvent

```text
01  Rendre compréhensible ce qui est complexe.
02  Automatiser la répétition — pas la responsabilité.
03  Préférer la preuve à « ça devrait marcher ».
04  Garder les échecs visibles plutôt que fabriquer des checks verts.
05  Utiliser l'IA pour étendre le jugement, pas pour le masquer.
06  L'architecture doit protéger l'itération, pas impressionner.
07  Livrer → observer → réparer → simplifier → recommencer.
```
...
<img src="https://img.shields.io/badge/APIs-0d1117?style=for-the-badge&logo=postman&logoColor=ff6c37" alt="APIs" />
<img src="https://img.shields.io/badge/Shopify-0d1117?style=for-the-badge&logo=shopify&logoColor=7ab55c" alt="Shopify" />
<img src="https://img.shields.io/badge/PrestaShop-0d1117?style=for-the-badge&logo=prestashop&logoColor=df0067" alt="PrestaShop" />
...
`agents IA avec validation` · `logiciels local-first` · `automatisation` · `outils multi-plateformes` · `observabilité` · `systèmes e-commerce` · `architecture produit` · `UX`
...
<div align="center">
  ...
  <picture>
    ...
    <img alt="Animation des contributions" src="https://raw.githubusercontent.com/niakw/niakw/output/github-contribution-grid-snake-dark.svg" width="94%" />
  </picture>
</div>
